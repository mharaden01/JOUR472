...
#The tables would be made by using slice_min and slice_max and organize by percent change to create the tables and n=10 to filter out the top 10 in each category. 
```

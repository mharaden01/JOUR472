...
A: To fix the state column, I would use the overwrite funtion with case_when() and mutate() to change the bottom two rows to say "Maryland" while keeping the rest of the data in the other columns the same. 

...
Questions:
    ...
    Editorial Director at CondeNast
...
```{r}
#your answer here A: Median Salary is $52000.
```


      2: Identify title, gender and race of the highest paid position at NYT  
```{r}
#your answer here Executive Editor, News, Black, noanswer for gender.
```
...
```{r}
#your answer here Median Salary: $50000.$2000 less than New York Times.
